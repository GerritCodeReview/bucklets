...
def generate_project_properties(plugin_name, plugin_dir, classes_dir, test_dir, output):
...
if __name__ == '__main__':
  ...
  generate_project_properties(args.n, plugin_dir, path.abspath(args.c), path.abspath(args.t), args.o)
